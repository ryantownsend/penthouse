...
module Penthouse
  module Runners
    class SchemaRunner < BaseRunner
      ...
      def self.load_tenant(tenant_identifier, previous_tenant_identifier = 'public')
        Tenants::SchemaTenant.new(tenant_identifier, tenant_schema: tenant_identifier, previous_schema: previous_tenant_identifier)
      end
